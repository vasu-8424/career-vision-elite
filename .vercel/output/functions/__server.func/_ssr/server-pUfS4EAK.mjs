...
//#region node_modules/.nitro/vite/services/ssr/assets/server-pUfS4EAK.js
var GLOBAL_TSR = "$_TSR";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D4NFKdKK.mjs");
